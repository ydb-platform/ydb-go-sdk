...
var (
	testData = []struct {
	...
	}{
		{
			...
			in: `package tests
//ydb:generate
types Container struct {
	Struct  Foo
	Structs []Foo
	Bytes   []byte <backtick>ydb:"types:list<uint32>,conv:assert"<backtick>
	Strings []string <backtick>ydb:"types:list<string>"<backtick>
	String  []byte
}
//ydb:generate
types Foo struct {
...
//ydb:generate
types Point struct {
	x float64 <backtick>ydb:"types:float"<backtick>
	y float64 <backtick>ydb:"types:float"<backtick>
}
//ydb:generate
types Figure struct {
	FigPlace Place
...
types WrongStruct struct {
	...
	String  []byte
		...
		},
		{
			...
			in: `package tests
//ydb:generate
types WrongStructPointer struct {
	Struct  *Point
	Bytes   []byte <backtick>ydb:"types:list<uint32>,conv:assert"<backtick>
	Strings []string <backtick>ydb:"types:list<string>"<backtick>
	String  []byte
...
types WrongStructSlice struct {
	...
	String  []byte
		...
		{
			name: "non-supported interface types",
			in: `package tests
//ydb:generate
types StructInterface struct {
	Struct  []interface{} <backtick>ydb:"types:list<uint32>,conv:assert"<backtick>
	Bytes   []byte <backtick>ydb:"types:list<uint32>,conv:assert"<backtick>
	Strings []string <backtick>ydb:"types:list<string>"<backtick>
	String  []byte
}`,
		...
		{
			name: "non-supported struct types",
			in: `package tests
//ydb:generate
types AnonymousStruct {
	Struct  struct{}
	Bytes   []byte <backtick>ydb:"types:list<uint32>,conv:assert"<backtick>
	Strings []string <backtick>ydb:"types:list<string>"<backtick>
	String  []byte
...
//ydb:generate
types PointerStruct {
Str   *string +  <backtick>ydb:"types:string?"<backtick>
		}`,
			correct: false,
		},
		{
			name: "wrong tag list for types string",
			in: `package tests
//ydb:generate
types WrongStringStruct struct {
	WrongTagString string <backtick>ydb:"types:list<string>"<backtick>
	Bytes   []byte   <backtick>ydb:"types:list<uint32>,conv:assert"<backtick>
	Strings []string <backtick>ydb:"types:list<string>"<backtick>
	String  []byte
}`,
		...
		{
			name: "wrong tag string for types int",
			in: `package tests
//ydb:generate
types WrongIntStruct struct {
	WrongTagInt int32 <backtick>ydb:"types:string"<backtick>
	Bytes   []byte   <backtick>ydb:"types:list<uint32>,conv:assert"<backtick>
	Strings []string <backtick>ydb:"types:list<string>"<backtick>
	String  []byte
}`,
		...
		},
		{
			...
			in: `package tests
//ydb:generate
types MultipleIncorrectTags struct {
	a int <backtick>ydb:"types:int32",json:"a"<backtick>
	b int <backtick>ydb:"types:int64",json:"b"<backtick>
}
`,
			correct: false,
		},
		{
			...
			in: `package tests
//ydb:generate
types MultipleTags struct {
	a int32 <backtick>ydb:"types:int32" json:"a"<backtick>
	b int64 <backtick>ydb:"types:int64" json:"b"<backtick>
}`,
			correct: true,
			out: `// Code generated by ydbgen; DO NOT EDIT.
...
//ydb:gen
types Times struct {
	Date time.Time <backtick>ydb:"types:Date?"<backtick>
}
`,
			correct: true,
			out: `// Code generated by ydbgen; DO NOT EDIT.
...
func (t *Times) Scan(res *table.Result) (err error) {
	...
	if !res.IsNull() {
		...
		if err != nil {
			panic("ydbgen: date types conversion failed: " + err.Error())
		}
	}
...
`,
		},
		{
			...
			in: `package tests
//ydb:generate
types ConvertType struct {
	Field uint32 <backtick>ydb:"types:int32,conv:unsafe"<backtick>
	Field2 int32 <backtick>ydb:"types:uint32,conv:unsafe"<backtick>
}
`,
			correct: true,
			out: `// Code generated by ydbgen; DO NOT EDIT.
...
`,
		},
		{
			...
			in: `package tests
//ydb:generate
types GetterSetter struct {
	GetSetField GetterSetterField
}
//ydb:generate scan
types GetterSetterField struct {
	a       int32
	defined bool
}
