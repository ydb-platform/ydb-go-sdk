...
func (t Trace) Compose(x Trace) (ret Trace) {
	...
	default:
		h1 := t.OnTest
		h2 := x.OnTest
		ret.OnTest = func(s string) func(string) {
			r1 := h1(s)
			r2 := h2(s)
			switch {
			case r1 == nil:
	...
	default:
		h1 := t.OnAction
		h2 := x.OnAction
		ret.OnAction = func(t TraceActionStart) func(TraceActionDone) {
			r1 := h1(t)
			r2 := h2(t)
			switch {
			case r1 == nil:
	...
	default:
		h1 := t.OnActionPtr
		h2 := x.OnActionPtr
		ret.OnActionPtr = func(t *TraceActionStart) func(*TraceActionDone) {
			r1 := h1(t)
			r2 := h2(t)
			switch {
			case r1 == nil:
	...
	default:
		h1 := t.OnSomething0
		h2 := x.OnSomething0
		ret.OnSomething0 = func(i int8) func(int16) func(int32) func(int64) {
			r1 := h1(i)
			r2 := h2(i)
			switch {
			case r1 == nil:
			...
			case r2 == nil:
				return r1
			default:
				return func(i int16) func(int32) func(int64) {
					r11 := r1(i)
					r21 := r2(i)
					switch {
					case r11 == nil:
	...
	default:
		h1 := t.OnSomething1
		h2 := x.OnSomething1
		ret.OnSomething1 = func(i int8, i1 int16) func(int32, int64) {
			r1 := h1(i, i1)
			r2 := h2(i, i1)
			switch {
			case r1 == nil:
	...
	default:
		h1 := t.OnSomething2
		h2 := x.OnSomething2
		ret.OnSomething2 = func(t Type) func(Type) func(Type) {
			r1 := h1(t)
			r2 := h2(t)
			switch {
			case r1 == nil:
	...
	switch {
	case t.OnAnother1 == nil:
		ret.OnAnother1 = x.OnAnother1
	case x.OnAnother1 == nil:
		ret.OnAnother1 = t.OnAnother1
	default:
		h1 := t.OnAnother1
		h2 := x.OnAnother1
		ret.OnAnother1 = func(named string) {
			h1(named)
			h2(named)
		}
	}
...
func (t Trace) onTest(ctx context.Context, s string) func(string) {
	c := ContextTrace(ctx)
...
func (t Trace) onAction(ctx context.Context, t1 TraceActionStart) func(TraceActionDone) {
	c := ContextTrace(ctx)
	...
	default:
		h1 := t.OnAction
		h2 := c.OnAction
		fn = func(t TraceActionStart) func(TraceActionDone) {
			r1 := h1(t)
			r2 := h2(t)
			switch {
			case r1 == nil:
...
func (t Trace) onActionPtr(ctx context.Context, t1 *TraceActionStart) func(*TraceActionDone) {
	c := ContextTrace(ctx)
	var fn func(*TraceActionStart) func(*TraceActionDone)
	switch {
	case t.OnActionPtr == nil:
...
func (t Trace) onSomething0(ctx context.Context, i int8) func(int16) func(int32) func(int64) {
	c := ContextTrace(ctx)
	...
	default:
		h1 := t.OnSomething0
		h2 := c.OnSomething0
		fn = func(i int8) func(int16) func(int32) func(int64) {
			r1 := h1(i)
			r2 := h2(i)
			switch {
			case r1 == nil:
...
func (t Trace) onSomething1(ctx context.Context, i int8, i1 int16) func(int32, int64) {
	c := ContextTrace(ctx)
...
func (t Trace) onSomething2(ctx context.Context, t1 Type) func(Type) func(Type) {
	c := ContextTrace(ctx)
	...
	default:
		h1 := t.OnSomething2
		h2 := c.OnSomething2
		fn = func(t Type) func(Type) func(Type) {
			r1 := h1(t)
			r2 := h2(t)
			switch {
			case r1 == nil:
...
func (t Trace) onAnother1(ctx context.Context, named string) {
	c := ContextTrace(ctx)
	var fn func(string)
	switch {
	case t.OnAnother1 == nil:
		fn = c.OnAnother1
	case c.OnAnother1 == nil:
		fn = t.OnAnother1
	default:
		h1 := t.OnAnother1
		h2 := c.OnAnother1
		fn = func(named string) {
			h1(named)
			h2(named)
		}
	}
...
func traceOnAction(ctx context.Context, t Trace, s string, nested Type) func(error) {
...
func traceOnSomething2(ctx context.Context, t Trace, e Embedded, s string, integer int, boolean bool, e1 error, r bytes.Reader) func(_ Embedded, _ string, integer int, boolean bool, _ error, _ bytes.Reader) func(_ Embedded, _ string, integer int, boolean bool, _ error, _ bytes.Reader) {
	var p Type
	p.Embedded = e
	p.String = s
	p.Integer = integer
	...
	return func(e Embedded, s string, integer int, boolean bool, e1 error, r bytes.Reader) func(Embedded, string, int, bool, error, bytes.Reader) {
		var p Type
		p.Embedded = e
		p.String = s
		p.Integer = integer
...
func traceOnAnother1(ctx context.Context, t Trace, named string) {
	t.onAnother1(ctx, named)
}
