...
func (c *Client) CreateSession(ctx context.Context) (s *Session, err error) {
	clientTraceCreateSessionDone := clientTraceOnCreateSession(c.trace, ctx)
	start := time.Now()
	defer func() {
...
func (s *Session) Close(ctx context.Context) (err error) {
	...
	s.closed = true
	clientTraceDeleteSessionDone := clientTraceOnDeleteSession(s.c.trace, ctx, s)
	start := time.Now()
	defer func() {
...
func (s *Session) KeepAlive(ctx context.Context) (info SessionInfo, err error) {
	clientTraceKeepAliveDone := clientTraceOnKeepAlive(s.c.trace, ctx, s)
	defer func() {
...
func (s *Statement) Execute(
	...
	clientTraceExecuteDataQueryDone := clientTraceOnExecuteDataQuery(s.session.c.trace, ctx, s.session, tx.id(), s.query, params)
	defer func() {
...
func (s *Session) Prepare(
	...
	clientTracePrepareDataQueryDone := clientTraceOnPrepareDataQuery(s.c.trace, ctx, s, query)
	defer func() {
...
func (s *Session) Execute(
	...
	clientTraceExecuteDataQueryDone := clientTraceOnExecuteDataQuery(s.c.trace, ctx, s, tx.id(), q, params)
	defer func() {
...
func (s *Session) StreamReadTable(ctx context.Context, path string, opts ...ReadTableOption) (_ *Result, err error) {
	...
	clientTraceStreamReadTableDone := clientTraceOnStreamReadTable(s.c.trace, ctx, s)
	if err != nil {
		cancel()
...
func (s *Session) StreamExecuteScanQuery(
	...
	clientTraceStreamExecuteScanQueryDone := clientTraceOnStreamExecuteScanQuery(s.c.trace, ctx, s, q, params)
	if err != nil {
		cancel()
...
func (s *Session) BeginTransaction(ctx context.Context, tx *TransactionSettings) (x *Transaction, err error) {
	clientTraceBeginTransactionDone := clientTraceOnBeginTransaction(s.c.trace, ctx, s)
	defer func() {
...
func (tx *Transaction) CommitTx(ctx context.Context, opts ...CommitTransactionOption) (r *Result, err error) {
	clientTraceCommitTransactionDone := clientTraceOnCommitTransaction(tx.s.c.trace, ctx, tx.s, tx.id)
	defer func() {
...
func (tx *Transaction) Rollback(ctx context.Context) (err error) {
	clientTraceRollbackTransactionDone := clientTraceOnRollbackTransaction(tx.s.c.trace, ctx, tx.s, tx.id)
	defer func() {
