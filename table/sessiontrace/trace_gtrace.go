...
func (t createSessionTrace) Compose(x createSessionTrace) (ret createSessionTrace) {
	...
	default:
		h1 := t.OnPutSession
		h2 := x.OnPutSession
		ret.OnPutSession = func(session *table.Session, err error) {
			h1(session, err)
			h2(session, err)
		}
	}
...
func (t createSessionTrace) onPutSession(session *table.Session, err error) {
	fn := t.OnPutSession
	if fn == nil {
		return
	}
...
func clientTraceOnCreateSession(t Trace, c context.Context) func(_ context.Context, _ *table.Session, endpoint string, latency time.Duration, _ error) {
	var p CreateSessionStartInfo
	p.Context = c
	res := t.onCreateSession(p)
	return func(c context.Context, s *table.Session, endpoint string, latency time.Duration, e error) {
...
func clientTraceOnKeepAlive(t Trace, c context.Context, s *table.Session) func(context.Context, *table.Session, options.SessionInfo, error) {
	var p KeepAliveStartInfo
	p.Context = c
	p.Session = s
	res := t.onKeepAlive(p)
	return func(c context.Context, s *table.Session, s1 options.SessionInfo, e error) {
...
func clientTraceOnDeleteSession(t Trace, c context.Context, s *table.Session) func(_ context.Context, _ *table.Session, latency time.Duration, _ error) {
	var p DeleteSessionStartInfo
	p.Context = c
	p.Session = s
	res := t.onDeleteSession(p)
	return func(c context.Context, s *table.Session, latency time.Duration, e error) {
...
func clientTraceOnPrepareDataQuery(t Trace, c context.Context, s *table.Session, query string) func(_ context.Context, _ *table.Session, query string, result *table.DataQuery, cached bool, _ error) {
	var p PrepareDataQueryStartInfo
	p.Context = c
	p.Session = s
	p.Query = query
	res := t.onPrepareDataQuery(p)
	return func(c context.Context, s *table.Session, query string, result *table.DataQuery, cached bool, e error) {
...
func clientTraceOnBeginTransaction(t Trace, c context.Context, s *table.Session) func(_ context.Context, _ *table.Session, txID string, _ error) {
	var p BeginTransactionStartInfo
	p.Context = c
	p.Session = s
	res := t.onBeginTransaction(p)
	return func(c context.Context, s *table.Session, txID string, e error) {
...
func clientTraceOnCommitTransaction(t Trace, c context.Context, s *table.Session, txID string) func(_ context.Context, _ *table.Session, txID string, _ error) {
...
func clientTraceOnRollbackTransaction(t Trace, c context.Context, s *table.Session, txID string) func(_ context.Context, _ *table.Session, txID string, _ error) {
...
func sessionPoolTraceOnCreate(t SessionPoolTrace, c context.Context) func(context.Context, *table.Session, error) {
	var p SessionPoolCreateStartInfo
	p.Context = c
	res := t.onCreate(p)
	return func(c context.Context, s *table.Session, e error) {
...
func sessionPoolTraceOnGet(t SessionPoolTrace, c context.Context) func(_ context.Context, _ *table.Session, latency time.Duration, retryAttempts int, _ error) {
	var p SessionPoolGetStartInfo
	p.Context = c
	res := t.onGet(p)
	return func(c context.Context, s *table.Session, latency time.Duration, retryAttempts int, e error) {
...
func sessionPoolTraceOnWait(t SessionPoolTrace, c context.Context) func(context.Context, *table.Session, error) {
...
func sessionPoolTraceOnTake(t SessionPoolTrace, c context.Context, s *table.Session) func(context.Context, *table.Session) func(_ context.Context, _ *table.Session, took bool, _ error) {
	var p SessionPoolTakeStartInfo
	p.Context = c
	p.Session = s
	res := t.onTake(p)
	return func(c context.Context, s *table.Session) func(context.Context, *table.Session, bool, error) {
		var p SessionPoolTakeWaitInfo
		p.Context = c
		p.Session = s
		res := res(p)
		return func(c context.Context, s *table.Session, took bool, e error) {
...
func sessionPoolTraceOnPut(t SessionPoolTrace, c context.Context, s *table.Session) func(context.Context, *table.Session, error) {
...
func sessionPoolTraceOnCloseSession(t SessionPoolTrace, c context.Context, s *table.Session) func(context.Context, *table.Session, error) {
...
func createSessionTraceOnPutSession(t createSessionTrace, session *table.Session, err error) {
