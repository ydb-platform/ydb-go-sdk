...
func (ExecuteScanQueryRequest_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1b2e4c4d1a772d33, []int{94, 0}
}
...
type PartitioningSettings struct {
	...
	//
	// Types that are valid to be assigned to Partitions:
	//	*PartitioningSettings_UniformPartitions
	//	*PartitioningSettings_PartitionAtKeys
	Partitions           isPartitioningSettings_Partitions `protobuf_oneof:"partitions"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
type isPartitioningSettings_Partitions interface {
	isPartitioningSettings_Partitions()
}

type PartitioningSettings_UniformPartitions struct {
	UniformPartitions uint64 `protobuf:"varint,8,opt,name=uniform_partitions,json=uniformPartitions,proto3,oneof"`
}

type PartitioningSettings_PartitionAtKeys struct {
	PartitionAtKeys *ExplicitPartitions `protobuf:"bytes,9,opt,name=partition_at_keys,json=partitionAtKeys,proto3,oneof"`
}

func (*PartitioningSettings_UniformPartitions) isPartitioningSettings_Partitions() {}

func (*PartitioningSettings_PartitionAtKeys) isPartitioningSettings_Partitions() {}

func (m *PartitioningSettings) GetPartitions() isPartitioningSettings_Partitions {
	if m != nil {
		return m.Partitions
	}
	return nil
...
func (m *PartitioningSettings) GetUniformPartitions() uint64 {
	if x, ok := m.GetPartitions().(*PartitioningSettings_UniformPartitions); ok {
		return x.UniformPartitions
	}
	return 0
}

func (m *PartitioningSettings) GetPartitionAtKeys() *ExplicitPartitions {
	if x, ok := m.GetPartitions().(*PartitioningSettings_PartitionAtKeys); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*PartitioningSettings) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*PartitioningSettings_UniformPartitions)(nil),
		(*PartitioningSettings_PartitionAtKeys)(nil),
	}
}

type AlterPartitioningSettings struct {
	// Enable/disable auto partitioning on reaching upper or lower partition size bound
	SetPartitioningBySize Ydb.FeatureFlag_Status `protobuf:"varint,1,opt,name=set_partitioning_by_size,json=setPartitioningBySize,proto3,enum=Ydb.FeatureFlag_Status" json:"set_partitioning_by_size,omitempty"`
	// Set preferred partition size for auto partitioning, Mb
	SetPartitionSizeMb uint64 `protobuf:"varint,2,opt,name=set_partition_size_mb,json=setPartitionSizeMb,proto3" json:"set_partition_size_mb,omitempty"`
	// Enable/disable auto partitioning based on load on each partition
	SetPartitioningByLoad Ydb.FeatureFlag_Status `protobuf:"varint,3,opt,name=set_partitioning_by_load,json=setPartitioningByLoad,proto3,enum=Ydb.FeatureFlag_Status" json:"set_partitioning_by_load,omitempty"`
	// Set minimum partitions count auto merge would stop working at
	SetMinPartitionsCount uint64 `protobuf:"varint,5,opt,name=set_min_partitions_count,json=setMinPartitionsCount,proto3" json:"set_min_partitions_count,omitempty"`
	// Set maximum partitions count auto split would stop working at
	SetMaxPartitionsCount uint64   `protobuf:"varint,6,opt,name=set_max_partitions_count,json=setMaxPartitionsCount,proto3" json:"set_max_partitions_count,omitempty"`
	XXX_NoUnkeyedLiteral  struct{} `json:"-"`
	XXX_unrecognized      []byte   `json:"-"`
	XXX_sizecache         int32    `json:"-"`
}

func (m *AlterPartitioningSettings) Reset()         { *m = AlterPartitioningSettings{} }
func (m *AlterPartitioningSettings) String() string { return proto.CompactTextString(m) }
...
func (m *AlterPartitioningSettings) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AlterPartitioningSettings.Unmarshal(m, b)
}
func (m *AlterPartitioningSettings) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AlterPartitioningSettings.Marshal(b, m, deterministic)
}
func (m *AlterPartitioningSettings) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlterPartitioningSettings.Merge(m, src)
}
func (m *AlterPartitioningSettings) XXX_Size() int {
	return xxx_messageInfo_AlterPartitioningSettings.Size(m)
}
func (m *AlterPartitioningSettings) XXX_DiscardUnknown() {
	xxx_messageInfo_AlterPartitioningSettings.DiscardUnknown(m)
}

var xxx_messageInfo_AlterPartitioningSettings proto.InternalMessageInfo

func (m *AlterPartitioningSettings) GetSetPartitioningBySize() Ydb.FeatureFlag_Status {
	if m != nil {
		return m.SetPartitioningBySize
	}
	return Ydb.FeatureFlag_STATUS_UNSPECIFIED
}

func (m *AlterPartitioningSettings) GetSetPartitionSizeMb() uint64 {
	if m != nil {
		return m.SetPartitionSizeMb
	}
	return 0
}

func (m *AlterPartitioningSettings) GetSetPartitioningByLoad() Ydb.FeatureFlag_Status {
	if m != nil {
		return m.SetPartitioningByLoad
	}
	return Ydb.FeatureFlag_STATUS_UNSPECIFIED
}

func (m *AlterPartitioningSettings) GetSetMinPartitionsCount() uint64 {
	if m != nil {
		return m.SetMinPartitionsCount
	}
	return 0
}

func (m *AlterPartitioningSettings) GetSetMaxPartitionsCount() uint64 {
	if m != nil {
		return m.SetMaxPartitionsCount
	}
	return 0
}
...
type CreateTableRequest struct {
	...
	PartitioningSettings *PartitioningSettings `protobuf:"bytes,13,opt,name=partitioning_settings,json=partitioningSettings,proto3" json:"partitioning_settings,omitempty"`
	// Enable/disable bloom filter by key
	KeyBloomFilter Ydb.FeatureFlag_Status `protobuf:"varint,14,opt,name=key_bloom_filter,json=keyBloomFilter,proto3,enum=Ydb.FeatureFlag_Status" json:"key_bloom_filter,omitempty"`
	// Read replicas settings for table
	ReadReplicasSettings *ReadReplicasSettings `protobuf:"bytes,15,opt,name=read_replicas_settings,json=readReplicasSettings,proto3" json:"read_replicas_settings,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
type AlterTableRequest struct {
	...
	// Alter settings for table partitioning
	AlterPartitioningSettings *AlterPartitioningSettings `protobuf:"bytes,16,opt,name=alter_partitioning_settings,json=alterPartitioningSettings,proto3" json:"alter_partitioning_settings,omitempty"`
	// Enable/disable bloom filter by key
...
func (m *AlterTableRequest) GetAlterPartitioningSettings() *AlterPartitioningSettings {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*AlterPartitioningSettings)(nil), "Ydb.Table.AlterPartitioningSettings")
...
var fileDescriptor_1b2e4c4d1a772d33 = []byte{
	...
	,
}
