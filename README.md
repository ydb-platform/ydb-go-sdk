...
[godoc](https://godoc.org/github.com/YandexDatabase/ydb-go-sdk/v3/)
...
```
go get -u github.com/YandexDatabase/ydb-go-sdk/v3
```
...
```
go get -u github.com/YandexDatabase/ydb-go-sdk/v3/cmd/ydbgen
```
