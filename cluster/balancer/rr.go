...
import (
	...
	"github.com/ydb-platform/ydb-go-sdk/v3/cluster/balancer/conn/list"
...
func (r *roundRobin) Insert(conn conn.Conn, info info.Info) BalancerElement {
...
func (r *roundRobin) Update(el BalancerElement, info info.Info) {
	e := el.(*list.Element)
	e.Info = info
	r.updateMinMax(info)
	r.belt = r.distribute()
