...
func DiscoveryOnDiscover(t *Discovery, c *context.Context, functionID string, address string, database string) func(location string, endpoints []EndpointInfo, _ error) {
...
func DiscoveryOnWhoAmI(t *Discovery, c *context.Context, functionID string) func(user string, groups []string, _ error) {
