...
func TableOnInit(t *Table, c *context.Context, functionID string) func(limit int, _ error) {
...
func TableOnClose(t *Table, c *context.Context, functionID string) func(error) {
...
func TableOnDo(t *Table, c *context.Context, functionID string, iD string, label string, idempotent bool, nestedCall bool) func(error) func(attempts int, _ error) {
...
func TableOnDoTx(t *Table, c *context.Context, functionID string, iD string, label string, idempotent bool, nestedCall bool) func(error) func(attempts int, _ error) {
...
func TableOnCreateSession(t *Table, c *context.Context, functionID string) func(error) func(session tableSessionInfo, attempts int, _ error) {
...
func TableOnSessionNew(t *Table, c *context.Context, functionID string) func(session tableSessionInfo, _ error) {
...
func TableOnSessionDelete(t *Table, c *context.Context, functionID string, session tableSessionInfo) func(error) {
...
func TableOnSessionKeepAlive(t *Table, c *context.Context, functionID string, session tableSessionInfo) func(error) {
...
func TableOnSessionBulkUpsert(t *Table, c *context.Context, functionID string, session tableSessionInfo) func(error) {
...
func TableOnSessionQueryPrepare(t *Table, c *context.Context, functionID string, session tableSessionInfo, query string) func(result tableDataQuery, _ error) {
...
func TableOnSessionQueryExecute(t *Table, c *context.Context, functionID string, session tableSessionInfo, query tableDataQuery, parameters tableQueryParameters, keepInCache bool) func(tx tableTransactionInfo, prepared bool, result tableResult, _ error) {
...
func TableOnSessionQueryExplain(t *Table, c *context.Context, functionID string, session tableSessionInfo, query string) func(aST string, plan string, _ error) {
...
func TableOnSessionQueryStreamExecute(t *Table, c *context.Context, functionID string, session tableSessionInfo, query tableDataQuery, parameters tableQueryParameters) func(error) func(error) {
...
func TableOnSessionQueryStreamRead(t *Table, c *context.Context, functionID string, session tableSessionInfo) func(error) func(error) {
...
func TableOnSessionTransactionBegin(t *Table, c *context.Context, functionID string, session tableSessionInfo) func(tx tableTransactionInfo, _ error) {
...
func TableOnSessionTransactionExecute(t *Table, c *context.Context, functionID string, session tableSessionInfo, tx tableTransactionInfo, query tableDataQuery, parameters tableQueryParameters) func(result tableResult, _ error) {
...
func TableOnSessionTransactionExecuteStatement(t *Table, c *context.Context, functionID string, session tableSessionInfo, tx tableTransactionInfo, statementQuery tableDataQuery, parameters tableQueryParameters) func(result tableResult, _ error) {
...
func TableOnSessionTransactionCommit(t *Table, c *context.Context, functionID string, session tableSessionInfo, tx tableTransactionInfo) func(error) {
...
func TableOnSessionTransactionRollback(t *Table, c *context.Context, functionID string, session tableSessionInfo, tx tableTransactionInfo) func(error) {
...
func TableOnPoolSessionNew(t *Table, c *context.Context, functionID string) func(session tableSessionInfo, _ error) {
...
func TableOnPoolSessionClose(t *Table, c *context.Context, functionID string, session tableSessionInfo) func() {
...
func TableOnPoolPut(t *Table, c *context.Context, functionID string, session tableSessionInfo) func(error) {
...
func TableOnPoolGet(t *Table, c *context.Context, functionID string) func(session tableSessionInfo, attempts int, _ error) {
...
func TableOnPoolWait(t *Table, c *context.Context, functionID string) func(session tableSessionInfo, _ error) {
