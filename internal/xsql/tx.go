...
var (
	_ driver.Tx                   = &tx{conn: nil, ctx: nil, tx: nil}
	_ driver.ExecerContext        = &tx{conn: nil, ctx: nil, tx: nil}
	_ driver.QueryerContext       = &tx{conn: nil, ctx: nil, tx: nil}
	_ table.TransactionIdentifier = &tx{conn: nil, ctx: nil, tx: nil}
)
