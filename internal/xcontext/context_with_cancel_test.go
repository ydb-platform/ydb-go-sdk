...
func TestContextWithCancelError(t *testing.T) {
	for _, tt := range []struct {
	...
	}{
		{
			...
			str: "context canceled at `github.com/ydb-platform/ydb-go-sdk/v3/internal/xcontext.TestContextWithCancelError.func1(context_with_cancel_test.go:47)`",
		},
		{
			err: func() error {
				ctx, cancel := WithCancel(context.Background())
			...
			str: "context canceled at `github.com/ydb-platform/ydb-go-sdk/v3/internal/xcontext.TestContextWithCancelError.func2(context_with_cancel_test.go:56)`",
		},
	} {
