...
import (
	...
	"github.com/ydb-platform/ydb-go-sdk/v3/internal/query/stats"
...
func (r *materializedResult) Stats() *stats.Query {
	return r.stats
}
...
func newMaterializedResult(resultSets []query.ResultSet, stats *stats.Query) *materializedResult {
...
func (r *result) Stats() *stats.Query {
