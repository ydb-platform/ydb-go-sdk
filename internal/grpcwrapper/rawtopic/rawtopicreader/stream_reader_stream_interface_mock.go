...
//
//	mockgen -destination stream_reader_stream_interface_mock.go -package rawtopicreader -write_package_comment=false --typed . TopicReaderStreamInterface
...
func (m *MockTopicReaderStreamInterface) Recv() (ServerMessage, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(ServerMessage)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockTopicReaderStreamInterfaceRecvCall) Return(arg0 ServerMessage, arg1 error) *MockTopicReaderStreamInterfaceRecvCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockTopicReaderStreamInterfaceRecvCall) Do(f func() (ServerMessage, error)) *MockTopicReaderStreamInterfaceRecvCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockTopicReaderStreamInterfaceRecvCall) DoAndReturn(f func() (ServerMessage, error)) *MockTopicReaderStreamInterfaceRecvCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Send mocks base method.
func (m *MockTopicReaderStreamInterface) Send(arg0 ClientMessage) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockTopicReaderStreamInterfaceSendCall) Do(f func(ClientMessage) error) *MockTopicReaderStreamInterfaceSendCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockTopicReaderStreamInterfaceSendCall) DoAndReturn(f func(ClientMessage) error) *MockTopicReaderStreamInterfaceSendCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
