...
//
//	mockgen -destination ../rawtopicreadermock/stream_reader_stream_interface_mock.go -package rawtopicreadermock -write_package_comment=false --typed . TopicReaderStreamInterface
