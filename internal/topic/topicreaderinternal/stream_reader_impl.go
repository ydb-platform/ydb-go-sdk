...
func (r *topicStreamReaderImpl) GetLogContext() context.Context {
	return r.cfg.BaseContext
}

func (r *topicStreamReaderImpl) SetLogContext(ctx context.Context) {
	r.cfg.BaseContext = ctx
}
