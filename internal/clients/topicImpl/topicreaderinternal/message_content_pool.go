...
//
//go:generate mockgen -destination=pool_interface_mock_test.go -write_package_comment=false -package=topicreaderinternal github.com/ydb-platform/ydb-go-sdk/v3/internal/clients/topicImpl/topicreaderinternal Pool
type Pool interface {
	Get() interface{}
	Put(x interface{})
}
