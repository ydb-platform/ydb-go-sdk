...
func WaitChannelClosed(tb testing.TB, ch <-chan struct{}) {
	tb.Helper()

	WaitChannelClosedWithTimeout(tb, ch, commonWaitTimeout)
}

func WaitChannelClosedWithTimeout(tb testing.TB, ch <-chan struct{}, timeout time.Duration) {
	tb.Helper()
