...
type describeExternalDataSourceClient interface {
	DescribeExternalDataSource(
		ctx context.Context, in *Ydb_Table.DescribeExternalDataSourceRequest, opts ...grpc.CallOption,
	) (*Ydb_Table.DescribeExternalDataSourceResponse, error)
}

func DescribeExternalDataSource(
	ctx context.Context,
	client describeExternalDataSourceClient,
	path string,
	...
	response, err := client.DescribeExternalDataSource(ctx, request)
	if err != nil {
		return desc, xerrors.WithStackTrace(err)
	}
...
type describeExternalTableClient interface {
	...
	) (*Ydb_Table.DescribeExternalTableResponse, error)
}

func DescribeExternalTable(
	ctx context.Context,
	client describeExternalTableClient,
	path string,
	...
	response, err := client.DescribeExternalTable(ctx, request)
	if err != nil {
		return desc, xerrors.WithStackTrace(err)
	}
