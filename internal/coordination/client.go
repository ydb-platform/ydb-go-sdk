...
func New(ctx context.Context, cc grpc.ClientConnInterface, config config.Config) *Client {
	onDone := trace.CoordinationOnNew(config.Trace(), &ctx,
		stack.FunctionIDType("github.com/ydb-platform/ydb-go-sdk/v3/internal/coordination.New"),
	)
	defer onDone()
...
func (c *Client) CreateNode(ctx context.Context, path string, config coordination.NodeConfig) (finalErr error) {
	...
	onDone := trace.CoordinationOnCreateNode(c.config.Trace(), &ctx,
		stack.FunctionIDType("github.com/ydb-platform/ydb-go-sdk/v3/internal/coordination.(*Client).CreateNode"),
		path,
	)
	defer func() {
		onDone(finalErr)
...
func (c *Client) AlterNode(ctx context.Context, path string, config coordination.NodeConfig) (finalErr error) {
	...
	onDone := trace.CoordinationOnAlterNode(c.config.Trace(), &ctx,
		stack.FunctionIDType("github.com/ydb-platform/ydb-go-sdk/v3/internal/coordination.(*Client).AlterNode"),
		path,
	)
	defer func() {
		onDone(finalErr)
...
func (c *Client) DropNode(ctx context.Context, path string) (finalErr error) {
	...
	onDone := trace.CoordinationOnDropNode(c.config.Trace(), &ctx,
		stack.FunctionIDType("github.com/ydb-platform/ydb-go-sdk/v3/internal/coordination.(*Client).DropNode"),
		path,
	)
	defer func() {
		onDone(finalErr)
...
func (c *Client) DescribeNode(
	...
	onDone := trace.CoordinationOnDescribeNode(c.config.Trace(), &ctx,
		stack.FunctionIDType("github.com/ydb-platform/ydb-go-sdk/v3/internal/coordination.(*Client).DescribeNode"),
		path,
	)
	defer func() {
		onDone(finalErr)
...
func (c *Client) Session(
	...
	onDone := trace.CoordinationOnSession(c.config.Trace(), &ctx,
		stack.FunctionIDType("github.com/ydb-platform/ydb-go-sdk/v3/internal/coordination.(*Client).Session"),
		path,
	)
	defer func() {
		onDone(finalErr)
...
func (c *Client) Close(ctx context.Context) (finalErr error) {
	...
	onDone := trace.CoordinationOnClose(c.config.Trace(), &ctx,
		stack.FunctionIDType("github.com/ydb-platform/ydb-go-sdk/v3/internal/coordination.(*Client).Close"),
	)
	defer func() {
		onDone(finalErr)
	}()
