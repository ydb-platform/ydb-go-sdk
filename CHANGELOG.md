## v3.95.6
* Added SQL/YQL parsers generation using ANTLR4
* Added parsers codegen check workflow in `check-codegen.yml`
* Modified `is_autogenerated_file.sh` not to work with ANTLR4 autogenerated files
