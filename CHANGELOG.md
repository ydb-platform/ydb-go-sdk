## v3.126.6
* Topic writer init stream logs now include endpoint (node_id, address, location) for the session — makes it easier to see on the server side which node is serving the writer
