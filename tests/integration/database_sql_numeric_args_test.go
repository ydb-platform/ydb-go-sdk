...
func (scope *sqlNumericArgsScope) fill(ctx context.Context, t *testing.T, db *sql.DB, prefix string) error {
...
func (scope *sqlNumericArgsScope) createTables(ctx context.Context, t *testing.T, db *sql.DB, prefix string) error {
