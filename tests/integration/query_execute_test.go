...
func TestQueryExecute(t *testing.T) {
	...
	t.Run("Execute", func(t *testing.T) {
		...
		t.Run("Stats", func(t *testing.T) {
			...
			require.NotNil(t, s)
			t.Logf("Stats: %+v", s)
			require.NotZero(t, s.Ast)
			require.NotZero(t, s.Plan)
			...
			require.NotEmpty(t, s.QueryPhases)
		})
	})
	t.Run("Stats", func(t *testing.T) {
		t.Run("Client", func(t *testing.T) {
			...
			t.Run("Do", func(t *testing.T) {
				t.Run("Execute", func(t *testing.T) {
					err = db.Query().Do(ctx, func(ctx context.Context, s query.Session) (err error) {
						...
						if len(queryStats.QueryPhases) == 0 {
			...
			t.Run("Execute", func(t *testing.T) {
				...
				require.NotZero(t, queryStats.Plan)
				require.NotZero(t, queryStats.Ast)
				...
				require.NotEmpty(t, queryStats.QueryPhases)
			})
		})
	})
